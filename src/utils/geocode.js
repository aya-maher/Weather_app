const request = require('request')
 ...
 const geocode = (address , callback) =>{
  const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + encodeURIComponent(address) + '.json?access_token=pk.eyJ1IjoiYXlhOCIsImEiOiJjazI5NGMxbHkxMWQxM3BzOTVzeDczanB2In0.Z3tdMdn_52LXa0wI5-AJhg'
